...
apt install ripgrep i3 i3blocks rofi papirus-icon-theme bleachbit vlc gimp contacts libreoffice libreoffice-l10n-de libreoffice-help-de alacritty git zsh syncthing brave-browser copyq geary virt-manager keepassxc zulumount-gui zulucrypt-gui tmux vifm pcmanfm gufw flatpak -y
